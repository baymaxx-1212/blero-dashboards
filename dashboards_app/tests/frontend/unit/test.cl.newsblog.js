...
// #############################################################################
// UNIT TEST
describe('cl.dashboards_app.js:', function () {
    beforeEach(function () {
    ...
    describe('Cl.newsBlog.init(): ', function () {
        ...
        it('runs _search()', function () {
            ...
            // validate 2 call as 2 js-aldryn-dashboards_app-dashboard-search is
    ...
    describe('Cl.newsBlog._search: ', function () {
        it('returns undefined', function () {
            ...
            expect(Cl.newsBlog._search(
                $('.js-aldryn-dashboards_app-dashboard-search').eq(1)))
                    .toEqual(undefined);
        });
        ...
        it('has correct url parameter in ajax request', function () {
            ...
            Cl.newsBlog._handler.call(
                $('.js-aldryn-dashboards_app-dashboard-search .form-inline')[0],
                    this.preventEvent);
