...
module.exports = function (config) {
    ...
    var settings = {
        ...
        files: [
            ...
            '../../dashboards_app/boilerplates/bootstrap3/static/js/libs/*.js',
            '../../dashboards_app/boilerplates/bootstrap3/static/js/addons/*.js',
        ...
        preprocessors: {
            '../../dashboards_app/boilerplates/bootstrap3/static/js/addons/*.js': ['coverage'],
            // for fixtures
            '**/*.html': ['html2js'],
            '**/*.json': ['json_fixtures']
        },
